...
3) Creación de punto WIFI

El ESP32-S3-secundario tiene implementado el código de la carpeta "video_streaming".
Funcionalidades:
1) Video streaming: Se conecta al punto WIFI y crea un servidor web desde donde se puede ver la retrasmisión de video en tiempo real desde otro dispositivo móvil accediendo a la dirección: http://192.168.4.2
